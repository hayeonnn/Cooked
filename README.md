...
> 페이즈 1(2026-09-08) 시점의 상세 기록은 [docs/phase-1.md](docs/phase-1.md)에 있다.
> 이 문서는 현재 상태를 설명한다.
...
이 시점에 정리한 자료는 읽기자료 13장과 2인 멀티 데모 영상이다. **그때 쓴 문서는 원문 그대로 [docs/phase-1.md](docs/phase-1.md)에 동결해 두었다.**
